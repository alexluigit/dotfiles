...
function! alex#autocmds#yank_post() abort
  ...
  " send to clipboard only when using 'y' operator
  if v:event.operator !~ "y" | return | endif
  call system('xclip -selection clipboard', @0)
  " use Osc52 trick in macOS and make sure tty variable has been passed in
...
" NOTE: make sure this is bsd version of 'echo' command
