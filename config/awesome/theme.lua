...
-- Icon/wallpaper path
local icon_path = cfg .. "icons/"
theme.wallpaper = icon_path .. "awesome.png"
...
theme.snap_shape = shapes.rrect(0)
...
theme.menu_submenu_icon = cfg .. "icons/submenu.png"
...
theme.hotkeys_shape = shape.custom_shape
...
theme.collision_focus_shape = shape.rrect(theme.border_radius)
...
theme.collision_max_shape = shape.rrect(0)
